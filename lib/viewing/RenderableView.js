    ...
    ReattachableView, {
        ...
        generateViewPlaceholders: function() {
            ...
            this.foreachChildView(function(viewRelationship, identifier, i) {
                ...
                this.viewPlaceholders[identifier] = viewPlaceholder(viewRelationship, placeholderId);
...
function viewPlaceholder(viewRelationship, placeholderId) {
    return {
        toString: function() {
            viewRelationship.placed = true;
