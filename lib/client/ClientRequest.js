    ...
    from: function(windough, requestId, environmentConfig) {
        ...
        var clientRequest = {
            ...
            onComplete: function(doSomething) {
                ...
                onCompleteHandlers.push(doSomething);
            },
            complete: function() {
                for (var i = 0, len = onCompleteHandlers.length; i < len; i++) {
                    onCompleteHandlers[i]();
                }
            }
        };

        addCookiesTo(clientRequest, windough, environmentConfig);
...
function addCookiesTo(clientRequest, windough, environmentConfig) {
    ...
    Object.defineProperty(clientRequest, "cookies", {
        get: function() {
...
function calculateCookiesFrom(windough) {
