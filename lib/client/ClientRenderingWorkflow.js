...
var promiseMethod = require("../util/promiseMethod");
...
var ClientRenderingWorkflow = {
    ...
    createHandlerFrom: function(originalHandler) {
        return function() {
            ...
            var fetchLayoutData = promiseMethod(function() {
            ...
            var chooseViewForRoute = promiseMethod(function() {
            ...
            if (!whenCurrentLayoutDataFetched) {
