...
var ClientRenderingWorkflow = {
    ...
    execute: function(router, originalHandler, params) {
        ...
        if (layoutForRouteIsDifferentFromCurrent) {
            return redirectOrLogAndRenderError(currentLayout, errorViewMappingForRoute, clientRequest, currentRequestId)(
                new Error(
        ...
        function renderLayout(requestId) {
            return function(view) {
                ...
                if (!layout.hasBeenRendered) {
                    layout.reattach();
                    layout.createChildView(Layout.CONTENT_ID, view);
                    layout.render();
                }
