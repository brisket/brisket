...
var ClientRenderingWorkflow = {
    ...
    createHandlerFrom: function(originalHandler) {
        return function() {
            ...
            var putLayoutBackToNormal = Promise.method(function() {
                layout.backToNormal();
            });
            ...
            var chooseViewForRoute = Promise.method(function() {
                var allParams = addExtraParamsTo(routeArguments, layout, clientRequest, clientResponse);
