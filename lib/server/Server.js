...
import ServerResponseWorkflow from "./ServerResponseWorkflow";
import DomainLocalStorage from "./DomainLocalStorage";
import Cookies from "../cookies/Cookies";
import forwardClientRequestToApi from "./forwardClientRequestToApi";
...
var Server = {
    ...
    create: function(config) {
        ...
        brisketEngine.use("/api", forwardClientRequestToApi(apiHost));
        brisketEngine.get(
            "*",
