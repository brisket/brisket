...
var proxyClientRequestToApi = require("./proxyClientRequestToApi");
...
var Server = {
    ...
    create: function(config) {
        ...
        var proxyClientRequestsToApi = config.proxyClientRequestsToApi;
        ...
        if (!!proxyClientRequestsToApi){
            brisketEngine.use(proxyClientRequestToApi(apiHost));
        }
        brisketEngine.get(
            "*",
