import RenderableView from '../../../lib/viewing/RenderableView.js';
...
describe('RenderableView', function() {
  ...
  let model;
  let BaseRenderableView;
  let ChildViewsInTemplate;
  let ViewThatRenders;
  let view;
  let childView;
  let childView1;
  ...
  describe('when entering the DOM', function() {
    let childViewInTemplate;
    let childViewWithIdentifier;
  ...
  describe('#renderTemplate', function() {
    ...
    describe('when templateAdapter has NOT been set', function() {
      ...
      it('throws an error', function() {
        const renderingTemplateWithoutTemplateAdapter = function() {
          view.renderTemplate();
        };
    ...
    describe('when TemplateAdapter is not a prototype of templateAdapter', function() {
      ...
      it('throws an error', function() {
        const renderingTemplateWithInvalidTemplateAdapter = function() {
          view.renderTemplate();
        };
  ...
  describe('rerendering', function() {
    ...
    describe('when view has child views', function() {
      ...
      beforeEach(function() {
        ...
        view = new ViewThatRenders({ model });
