...
describe('ClientRequest', function() {
  ...
  describe('from returns Brisket normalized values', function() {
    ...
    describe('when route registers work on complete', function() {
      let onCompleteHandler1;
      let onCompleteHandler2;
    ...
    describe('when the previous request is set', function() {
      ...
      beforeEach(function() {
        const firstRequest = ClientRequest.from(mockWindow());
    ...
    describe('when server has cookies', function() {
      let mockWindowWithCookies;
      let mockWindowWithSameCookies;
      let mockWindowWithNewCookies;
      let nextClientRequest;
