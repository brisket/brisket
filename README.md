...
To use brisket you must install the npm module into your project. Although we do not have an internal npm registry, for now, you can add it to your `package.json`. Use a hash at the end of the git url to specify the version you want to use:
...
### Browser Support:
Chrome, Firefox, Safari, IOS6+, Android, IE9+

For support in old versions of IE you can include your favorite shim libraries in the head of your layout. For example to support IE8 include the following in your head tag:
...
## License
Apache Software License (Version 2). See license text in [LICENSE](LICENSE).
